...
def add_tasks(data: TaskCreate, db=Depends(get_db)):
    user_id = 1
...
def update_task_details(id: int, data: TaskUpdate, db=Depends(get_db)):
    user_id = 1
